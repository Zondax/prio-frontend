...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: React.ComponentProps<typeof DayPicker>) {
  return (
    <DayPicker
      ...
      components={{
        IconLeft: ({ className, children, ...props }) => <ChevronLeftIcon className={cn('size-4', className)} {...props} />,
        IconRight: ({ className, children, ...props }) => <ChevronRightIcon className={cn('size-4', className)} {...props} />,
      }}
      {...props}
    />
  )
