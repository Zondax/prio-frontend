...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@zondax/ui-web': resolve(__dirname, '../../libs/ui-web/src'),
      '@zondax/ui-web/server': resolve(__dirname, '../../libs/ui-web/src/server'),
      '@zondax/ui-web/client': resolve(__dirname, '../../libs/ui-web/src/client'),
    },
  },
})
