...
import { type ChatChannelDetail, getAllChatsWithDetails } from '@/app/(app)/prio/store/prio-mock-data'

type ChatItem = ChatChannelDetail
...
export default function AllChatsPage() {
  ...
  const handleChatPreview = useCallback((chat: ChatItem, e: React.MouseEvent) => {
    e.stopPropagation()
