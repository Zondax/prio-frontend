...
export const iOSAppAttestErrors: { [code: string]: AppIntegrityError } = {
  UNKNOWN_SYSTEM_FAILURE: {
    ...
    errorCode: 20,
    documentation: 'https://developer.apple.com/documentation/devicecheck/dcerror/2896947-unknownsystemfailure',
    detail: 'A failure has occurred, such as the failure to generate a token.',
    userFriendlyMessage: 'App integrity verification failed. Please try again. Error code: 25',
  ...
  INVALID_KEY: {
    code: 'INVALID_KEY',
    errorCode: 21,
    documentation: 'https://developer.apple.com/documentation/devicecheck/dcerror/3585177-invalidkey',
    detail: 'An error caused by a failed attempt to use the App Attest key',
    userFriendlyMessage: 'App integrity verification failed. Please try again. Error code: 21',
    resolution:
  ...
  INVALID_INPUT: {
    code: 'INVALID_INPUT',
    errorCode: 22,
    documentation: 'https://developer.apple.com/documentation/devicecheck/dcerror/3585176-invalidinput',
    detail: "An error code that indicates when your app provides data that isn't formatted correctly.",
    userFriendlyMessage: 'App integrity verification failed. Please try again. Error code: 22',
    resolution:
  ...
  SERVER_UNAVAILABLE: {
    ...
    errorCode: 23,
    documentation: 'https://developer.apple.com/documentation/devicecheck/dcerror/3585178-serverunavailable',
    detail:
  ...
  FEATURE_UNSUPPORTED: {
    ...
    errorCode: 24,
    documentation: 'https://developer.apple.com/documentation/devicecheck/dcerror/2896943-featureunsupported',
    detail: 'DeviceCheck is not available on this device.',
    userFriendlyMessage: 'App integrity verification failed. Please try again on another device. Error code: 24',
    resolution:
  ...
  EXECUTED_IN_SIMULATOR: {
    ...
    errorCode: 25,
    documentation: 'How to create an iOS development build with EAS: https://docs.expo.dev/build/setup/',
    detail: 'App Attest requires a physical device and will not work in a simulator.',
    userFriendlyMessage: 'App integrity verification failed. Please try again on another device. Error code: 25',
    resolution: 'You will need an Apple Developer Account and an iOS development build of your application to test this functionality.',
    resolutionType: ErrorResolutionTypes.DEVELOPER_ACTION_REQUIRED,
  },
}
