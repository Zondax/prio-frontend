...
export const AndroidIntegrityErrors: { [code: string]: AppIntegrityError } = {
  ...
  APP_NOT_INSTALLED: {
    ...
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 0',
  ...
  API_UID_MISMATCH: {
    ...
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 1',
    resolution: 'Non-actionable',
    resolutionType: ErrorResolutionTypes.NON_ACTIONABLE,
  },
  ...
  API_NOT_AVAILABLE: {
    ...
    detail: 'Integrity API is not available. Integrity API is not enabled, or the Play Store version might be old.',
    userFriendlyMessage:
  ...
  PLAY_STORE_NOT_FOUND: {
    ...
    detail: 'No Play Store app is found on device or unofficial version is installed.',
    userFriendlyMessage:
    ...
    resolution: 'Ask the user to install an official and recent version of Play Store.',
    resolutionType: ErrorResolutionTypes.USER_ACTION_REQUIRED,
  },
  ...
  CLIENT_TRANSIENT_ERROR: {
    ...
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 10',
    resolution: 'Retry with an exponential backoff. Consider filing a bug if it fails consistently.',
    resolutionType: ErrorResolutionTypes.DEVELOPER_ACTION_REQUIRED,
  },
  ...
  CLOUD_PROJECT_NUMBER_IS_INVALID: {
    ...
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 13',
  ...
  NONCE_IS_NOT_BASE64: {
    ...
    detail: 'Configuration error: the provided nonce is not encoded as a base64 web-safe no-wrap string. Retry with correct nonce format.',
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 14',
    resolution: 'Ensure the nonce is encoded as a base64 web-safe no-wrap string.',
    resolutionType: ErrorResolutionTypes.DEVELOPER_ACTION_REQUIRED,
  },
  ...
  NONCE_TOO_LONG: {
    ...
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 15',
    resolution: 'Ensure the nonce is less than 500 bytes before base64 encoding.',
    resolutionType: ErrorResolutionTypes.DEVELOPER_ACTION_REQUIRED,
  },
  ...
  NONCE_TOO_SHORT: {
    ...
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 16',
    resolution: 'Ensure the nonce is a minimum of 16 bytes (before base64 encoding).',
    resolutionType: ErrorResolutionTypes.DEVELOPER_ACTION_REQUIRED,
  },
  ...
  TOO_MANY_REQUESTS: {
    ...
    detail: 'The calling app is making too many requests to the API and hence is throttled.',
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 17',
  ...
  NO_ERROR: {
    ...
    detail: 'No error occurred. This error code was likely included in the App Integrity API for completeness.',
  ...
  INVALID_INTEGRITY_TOKEN_RESPONSE: {
    ...
    detail: 'Google Play Integrity API did not return an error, but the integrity token was null',
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 19',
    resolution: 'Retry with an exponential backoff. Consider filing a bug with `expo-app-integrity` repository if it fails consistently.',
    resolutionType: ErrorResolutionTypes.DEVELOPER_ACTION_REQUIRED,
  },
  INVALID_IS_SUPPORTED_API: {
    ...
    errorCode: 20,
    documentation: 'https://gihub.com/jeffDevelops/expo-app-integrity',
    detail: '`AppIntegrity.isSupported()` is only exposed on iOS, but was called on Android.',
    userFriendlyMessage: 'App integrity verification with the Google Play Store failed. Please try again. Error code: 20',
    resolution:
