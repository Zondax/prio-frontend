...
const Large = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText
  return <Component className={cn('text-xl text-foreground font-semibold web:select-text', className)} ref={ref} {...props} />
})
...
const Small = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText
  return <Component className={cn('text-sm text-foreground font-medium leading-none web:select-text', className)} ref={ref} {...props} />
})
